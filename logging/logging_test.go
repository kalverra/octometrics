...
func TestLogging(t *testing.T) {
	...
	t.Run("with file", func(t *testing.T) {
		...
		require.Contains(t, string(logFileData), "This is an info log message.", "log file should contain info log message")
		require.Contains(t, string(logFileData), "This is a debug log message.", "log file should contain debug log message")
		require.Contains(t, string(logFileData), "This is an error log message.", "log file should contain error log message")
		require.Contains(t, string(logFileData), "This is a trace log message.", "log file should contain trace log message")
		require.Contains(t, string(logFileData), "This is a warning log message.", "log file should contain warning log message")
	})
}
